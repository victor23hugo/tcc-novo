...
export async function salvar(idUsuario, endereco) {
    ...
    const [info] = await con.query(comando, [idUsuario,endereco.cep, endereco.referencia, endereco.logradouro, endereco.bairro, endereco.cidade, endereco.estado, endereco.numero, endereco.complemento]);
